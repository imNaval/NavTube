...
const Sidebar = () => {
  ...
  return (
    <div className={`col-span-1 sm:col-span-2 p-0 z-40 shadow-lg ${isDark ? 'text-white bg-gray-900' : 'bg-white'}`}>
      <div className='p-5 h-screen' onClick={()=> dispatch(toggleMenu()) }>
        <ul>
